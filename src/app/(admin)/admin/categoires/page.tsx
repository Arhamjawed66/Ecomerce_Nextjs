...
import { AddCategory } from "@/components/ui/AddCategoire/AddCategoire"
...
export default function Categories() {
  return (
    ...
    <div className="flex justify-between">
      <h1 className="font-bold  transition ease-in-out delay-150 hover:cursor-pointer hover:-translate-y-1 hover:scale-110  duration-300 ...">Category</h1>
      <AddCategory/>
      </div>
    <Table>
